        ...
        ModSettingsRegistry.UpsertRegistration(new ModSettingsRegistration
        {
            ...
            NumberSettings = new[]
            {
                ...
                new ModSettingNumberDefinition
                {
                    ...
                    Label = "HP Sacrifice %",
                    Description = "Fraction of your current HP lost per sacrifice (0.01–1.0). Capped so a single choice cannot exceed 1/N of your max HP.",
                    Path = "Settings/Event",
                ...
                new ModSettingNumberDefinition
                {
                    ...
                    Description = "How many times you may sacrifice HP for gold (1–10).",
                    Path = "Settings/Event",
                    AllowMultiplayerOverwrite = true,
                    DefaultValue = 4,
                    MinValue = 1,
